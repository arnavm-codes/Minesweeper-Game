...
tile_exploded = (pygame.transform.scale(pygame.image.load(os.path.join("Assets", f"Flagxploded.png")), (tile_size, tile_size)))
...
tile_unknown = (pygame.transform.scale(pygame.image.load(os.path.join("Assets", f"TilUnknown.png")), (tile_size, tile_size)))
